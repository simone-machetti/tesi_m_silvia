...
| 8 | §2.3.1, 5° capoverso | «Sonuga-Barke» spezzato a fine riga («Sonuga-/Barke», pag. 36) | cognome tenuto unito con `\mbox{}` | impaginazione | nome proprio spezzato al trattino; il verificatore ora ignora `\mbox` (`strumenti/verify.py`) |
