    ...
    \node[yshift=-8cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
        ...
        \node[anchor=north west,yshift=-7.2cm,xshift=37mm,text width=\textwidth,minimum height=30mm,inner sep=0mm] at (current page.north west)
              % Titolo a bandiera e senza sillabazione: a capo solo fra le parole,
              % mai a meta' parola (nel capitolo 1 usciva "...sviluppo tipi-/co").
              {\parbox[top][30mm][t]{\textwidth}{\raggedright\hyphenpenalty=10000\exhyphenpenalty=10000\color{black}#1}};
       \end{tikzpicture}
      };
   \end{tikzpicture}
   \gdef\chapterlabel{}
...
\titleformat{\part}[display]
    ...
    \node[anchor=north west,xshift=-65mm,yshift=-6.9cm-\value{myparts}*20mm] at (current page.north east)
      {\begin{tikzpicture}[remember picture, overlay]
        ...
        {\parbox[top][30mm][t]{55mm}{\raggedright \color{white}\partname\ \partlabel $\phantom{\textrm{l}}$}};
