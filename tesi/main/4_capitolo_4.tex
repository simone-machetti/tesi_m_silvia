...
\addcontentsline{lot}{table}{Tabella 4.1 --- Profilo dei fattori di rischio dei bambini selezionati}
\emph{Tabella 4.1 --- Profilo dei fattori di rischio dei bambini selezionati (dati dal questionario compilato dai genitori).}
\end{minipage}
\end{table}
...
\emph{Codifica: 0 = esecuzione non corretta; 1 = esecuzione parziale; 2 = esecuzione corretta; NV = prova non valutabile; n.d. = dato mancante. I punteggi complessivi e i percentili sono riportati nella sezione aggregata; qui sono presentate le risposte alle singole prove.}
...
\emph{Compilato dalla somministratrice al termine della valutazione. Tre livelli di frequenza: 0 = mai o raramente; 1 = qualche volta; 2 = per la maggior parte del tempo.}
...
Per quanto riguarda il Baby-FE, nella Tabella 4.2 sono riportati, per ciascun caso, l'età alla somministrazione, il punteggio totale, il numero di prove non valide e la collocazione percentile rispetto alla distribuzione dei punteggi osservata nel campione totale dello studio. I percentili riportati hanno esclusivamente una funzione descrittiva, in quanto sono stati calcolati sulla distribuzione dei punteggi osservata nel campione totale dello studio (N = 66), assunto come riferimento per la collocazione degli otto casi selezionati.

\begin{table}[htbp]
\centering
\begin{minipage}{\textwidth}\justifying
\addcontentsline{lot}{table}{Tabella 4.2. Prestazioni complessive al Baby-FE nei casi selezionati}
\textbf{Tabella 4.2. Prestazioni complessive al Baby-FE nei casi selezionati}
\end{minipage}
\par\medskip
