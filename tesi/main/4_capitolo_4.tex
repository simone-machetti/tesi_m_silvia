...
Il principale strumento di valutazione utilizzato nel presente studio è stato il \mbox{Baby-FE}, già descritto nel Capitolo~\ref{cap:tre}. Lo strumento è stato sviluppato con l'obiettivo di valutare i precursori delle capacità di regolazione nell'ambito delle prospettive teoriche sulle funzioni esecutive e consente di osservare, attraverso una situazione di gioco strutturata, comportamenti riconducibili ai principali processi coinvolti nello sviluppo del funzionamento regolativo, fornendo una misura delle competenze emergenti del bambino in questa specifica fascia d'età.
...
I fattori di rischio considerati, ricavati dal medesimo questionario, comprendono la preoccupazione espressa per lo sviluppo del bambino, il suggerimento di visite specialistiche, la loro effettuazione, la presenza di problemi alla nascita e la nascita pretermine. Sulla base di tale criterio sono stati selezionati otto bambini, accomunati dalla compresenza di più fattori di rischio, il cui profilo è sintetizzato nella Tabella~\ref{tab:rischio}.
...
\begin{tabular}{|c|c|>{\centering\arraybackslash}p{1.0cm}|>{\centering\arraybackslash}p{1.9cm}|>{\centering\arraybackslash}p{1.5cm}|>{\centering\arraybackslash}p{1.6cm}|>{\centering\arraybackslash}p{1.6cm}|>{\centering\arraybackslash}p{1.7cm}|>{\centering\arraybackslash}p{1.2cm}|}
\toprule
\textbf{Caso} & \textbf{Genere} & \textbf{Età\newline(mesi)} & \textbf{Pretermine} & \textbf{Problemi alla nascita} & \textbf{Preoccup. sviluppo} & \textbf{Visite suggerite} & \textbf{Visite effettuate} & \textbf{N.\newline fattori} \\
\midrule
1 & F & 33 & -- & SÌ & SÌ & -- & SÌ & 3 \\
2 & F & 31 & -- & -- & SÌ & SÌ & SÌ & 3 \\
3 & M & 31 & -- & SÌ & SÌ & SÌ & -- & 3 \\
...
% (nessuna barriera fra un caso e l\'altro: creava pagine quasi vuote, vedi tasks.md)
 \subsubsection*{Caso 1}
 \phantomsection\addcontentsline{toc}{subsubsection}{Caso 1}
...
% (nessuna barriera fra un caso e l\'altro: creava pagine quasi vuote, vedi tasks.md)
 ...
 \phantomsection\addcontentsline{toc}{subsubsection}{Caso 2}
...
% (nessuna barriera fra un caso e l\'altro: creava pagine quasi vuote, vedi tasks.md)
 ...
 \phantomsection\addcontentsline{toc}{subsubsection}{Caso 3}
...
% (nessuna barriera fra un caso e l\'altro: creava pagine quasi vuote, vedi tasks.md)
 ...
 \phantomsection\addcontentsline{toc}{subsubsection}{Caso 4}
...
% (nessuna barriera fra un caso e l\'altro: creava pagine quasi vuote, vedi tasks.md)
 ...
 \phantomsection\addcontentsline{toc}{subsubsection}{Caso 5}
...
% (nessuna barriera fra un caso e l\'altro: creava pagine quasi vuote, vedi tasks.md)
 ...
 \phantomsection\addcontentsline{toc}{subsubsection}{Caso 6}
...
% (nessuna barriera fra un caso e l\'altro: creava pagine quasi vuote, vedi tasks.md)
 ...
 \phantomsection\addcontentsline{toc}{subsubsection}{Caso 7}
...
% (nessuna barriera fra un caso e l\'altro: creava pagine quasi vuote, vedi tasks.md)
 ...
 \phantomsection\addcontentsline{toc}{subsubsection}{Caso 8}
...
\par\medskip
\begin{minipage}{\textwidth}\justifying
\emph{Nota. IC~=~controllo inibitorio; FX~=~flessibilità; WM~=~memoria di lavoro; RG~=~regolazione; n.d.~=~dato non disponibile. Sono evidenziati i punteggi collocati indicativamente almeno una deviazione standard al di sotto della media osservata nel campione totale dello studio. I punteggi corrispondenti al 10° e al 20° percentile della distribuzione osservata nel campione totale sono, rispettivamente: IC~=~2,8 e 3,3; FX~=~3,4 e 3,9; WM~=~3,5 e 4,0; RG~=~3,3 e 3,7. Tali valori costituiscono riferimenti descrittivi interni al campione dello studio, non distinti per fascia d'età, e non assumono valore normativo.}
\end{minipage}
\end{table}

Anche i punteggi dell'EEFQ evidenziano una marcata eterogeneità tra i bambini selezionati. Considerando come riferimento i valori osservati nel campione totale dello studio, gli scostamenti più consistenti non interessano una singola dimensione, ma risultano distribuiti tra le diverse sottoscale. Punteggi collocati indicativamente almeno una deviazione standard al di sotto della media si osservano nel controllo inibitorio per i Casi 1, 7 e 8, nella flessibilità per i Casi 4 e 8, nella memoria di lavoro per i Casi 5, 6 e 7 e nella regolazione per i Casi 1, 5 e 6. La collocazione rispetto al 10° e al 20° percentile della distribuzione osservata nel campione totale consente di precisare ulteriormente tali scostamenti. In particolare, il Caso 8 si colloca al di sotto del 10° percentile nel controllo inibitorio e nella flessibilità e il Caso 5 nella memoria di lavoro e nella regolazione; tra il 10° e il 20° percentile si collocano invece i Casi 1 e 7 nel controllo inibitorio, il Caso 4 nella flessibilità e il Caso 7 nella memoria di lavoro. Il Caso 1 presenta inoltre un punteggio corrispondente al 10° percentile nella regolazione, mentre il Caso 6 si colloca in corrispondenza del 20° percentile nella memoria di lavoro e appena al di sopra di tale riferimento nella regolazione. Il Caso 3 presenta invece valori prossimi alle medie osservate nel campione totale dello studio in tutte le dimensioni considerate.
...
\FloatBarrier
% Titolo aggiunto nel controllo finale (cap_4.md): nel Word esistevano solo 4.4.1 e
% 4.4.2 senza un titolo padre, e la numerazione era forzata con \setcounter.
\section{Discussione}
\label{sec:4_4}
